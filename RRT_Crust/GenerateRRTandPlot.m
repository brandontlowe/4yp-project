function tree = GenerateRRTandPlot(xinit, goalgraph, K, n)
...
%    xnew = xinit;
    ...
    for k = 1:K
        ...
        hold on
       quiver(tree.Nodes.x, tree.Nodes.y, (tree.Nodes.f).*cos(tree.Nodes.theta), (tree.Nodes.f).*sin(tree.Nodes.theta),2);
